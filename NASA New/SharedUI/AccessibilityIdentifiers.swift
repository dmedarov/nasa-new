...
enum AccessibilityID {
    ...
    static let clearOfflineMediaButton = "clearOfflineMediaButton"
    static let rebuildOfflineMediaButton = "rebuildOfflineMediaButton"
    static let offlineMediaActionStatus = "offlineMediaActionStatus"
